...
class Args():
    def __init__(self):
        ...
        self.embedding_size_rnn = int(
            64/self.parameter_shrink)  # the size for LSTM input
        ...
        # how many batches of samples per epoch, default 32, e.g., 1 epoch = 32 batches
        self.batch_ratio = 32
        self.epochs = 5  # now one epoch means self.batch_ratio x batch_size
        ...
        self.fname_baseline = self.graph_save_path + self.graph_type + \
            self.generator_baseline+'_'+self.metric_baseline
